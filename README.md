...
<head>
    ...
    <title>cartita uwu</title>
    <style>
        body {
            margin: 0;
            padding: 0;
            background: linear-gradient(135deg, #ffe1e1, #ffcccb, #ffb6c1, #ff9999, #ff7f7f, #ff6666);
            background-size: 600%;
        ...
        @keyframes glow {
            0% { border-color: #ff6f61; box-shadow: 0 0 10px #ff6f61; }
            50% { border-color: #ff4d4d; box-shadow: 0 0 20px #ff4d4d; }
            100% { border-color: #ff6f61; box-shadow: 0 0 10px #ff6f61; }
        }
        ...
        .particle:nth-child(14) { left: 70%; animation-delay: 3.9s; }
...
Por ti desafiaría tormentas y mares,
